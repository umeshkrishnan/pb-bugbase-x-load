...
#define FNAME_COPY_LOCATION    0x80500000
#define READ_BLOCK_LOCATION    0x80500880

char *fnamecopy = (char *)FNAME_COPY_LOCATION;
__u8 *do_fat_read_block = (__u8 *)READ_BLOCK_LOCATION;
