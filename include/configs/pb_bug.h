 ...
 *
 * X-Loader Configuation settings for the PB-BUGBASE board.
 *
 * Derived from include/configs/bug.h
 *
...
#define CONFIG_PB_BUGBASE	1	/* working with BUGBASE2 */
 ...
 */
#define CONFIG_SERIAL1           3    /* UART3 on BUGBASE2 */
